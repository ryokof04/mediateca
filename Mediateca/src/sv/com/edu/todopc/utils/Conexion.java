...
//El puertoesopcional
    private static String JDBC_URL = "jdbc:mysql://localhost/db_mediateca?useSSL=false";
    private static String JDBC_USER = "root";
    private static String JDBC_PASS = "root";
    private static Driver driver = null;
//Para que no haya problemas al obtener la conexion de
//manera concurrente, seu sa la palabra synchronized

    public static synchronized Connection getConnection()
            throws SQLException {//manera concurrente, seu sa la palabra synchronized
